 ...
 * @author santi
 */
public class MVCPages extends BodyTagSupport {
    private String nomeDaPagina;
    private String nomeDoTratador;
    
    public void setNomeDaPagina(String pageName) {
        this.nomeDaPagina = pageName;
    }

    public void setNomeDoTratador(String managerName) {
        this.nomeDoTratador = managerName;
    }
    ...
    private void otherDoStartTagOperations() {
        try {
            ...
            out.println(
"<body><div id=\"idHeader\"><div id=\"idNomeSite\">"+nomeDaPagina+"</div>"+
"<div id=\"idDELPOLI\">EEL418 / DEL / POLI / UFRJ</div></div><div id=\"idlista\">&nbsp;</div>"+
"<form method=\"GET\" action=\"controller\"><input type=\"hidden\""+
"name=\"nomeDoTratadorDePagina\"value=\""+nomeDoTratador+"\"/>"
            );
        }
